    ...
    <section className="rounded-lg border border-slate-800 bg-slate-900 p-3">
      ...
      <div className="mb-2">
        <div className="mb-1 flex justify-between text-[11px] text-slate-400">
          <span>Daño físico {physicalPct}%</span>
          <span>Mágico {100 - physicalPct}%</span>
        </div>
        <div
          className="flex h-2.5 overflow-hidden rounded-full bg-slate-800"
          role="meter"
          aria-label="Reparto de daño enemigo"
      ...
      <div className="mb-2">
        <div className="mb-1 flex justify-between text-[11px] text-slate-400">
          <span>Tanquismo</span>
          <span className="font-mono">{Math.round(aggregates.tankinessIndex)} HP ef.</span>
        </div>

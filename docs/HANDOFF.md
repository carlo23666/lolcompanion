# HANDOFF — archived project guide, roadmap & ideas (2026-07-06)

> **Superseded for current state.** Read `AGENTS.md`, `docs/architecture.md`,
> `docs/decisions.md` (especially ADR-010), the latest `docs/worklog.md` entry and the active
> work package instead. Identity and roadmap notes below are historical context only.

**Current release:** WinCon 1.6.0 (2026-07-13). It includes the core-first build-route engine,
Rift/Dark/Sakura identities, movable and scalable bottom overlay, typed item-rich purchase speech,
the conservative visible-material 1v1 signal, and the refreshed bilingual site. See
`docs/releases/1.6.0.md` and worklog entry 38; the detailed “v0.1.0” inventory below is archived.

This is the master handoff for **any** AI model or human resuming work on WinCon.
...
- **Distribution** (2026-07-06): `npm run dist` builds a per-user NSIS installer
  (`dist/WinCon-<version>-setup.exe`), icon generated by `scripts/make-icon.mjs`.
